...
// ── Cream/editorial design matching WhoIServe + GForce case study HTML
const CREAM = '#f8f6f1';
const INK = '#0d0f13';
const ACCENT = '#c9553a';
const ACCENT_LIGHT = '#e8734f';
const MUTED = '#6b6e76';
        ...
        <div className="max-w-3xl mx-auto space-y-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
            {[
              ...
              { number: '3', desc: 'Claim categories: Supported, Unverified, Inconsistent' },
              { number: '100%', desc: 'Verifiable — every finding links to the original source' },
            ].map((stat) => (
              <div
                key={stat.number}
          ...
          <hr style={{ border: 'none', borderTop: `2px solid ${BORDER}`, margin: '48px 0' }} />
      ...
      <section className="py-20 md:py-28 px-4 md:px-8 text-center">
        <div className="max-w-2xl mx-auto">
          <h2
            ...
            style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(28px, 4vw, 36px)', letterSpacing: '-0.5px', color: INK }}
          >
          ...
          <Link href="/#contact">
            <button
              className="px-10 py-4 rounded-full font-bold text-base text-white transition-all"
              style={{ backgroundColor: ACCENT, cursor: 'pointer', letterSpacing: '0.5px' }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLButtonElement).style.backgroundColor = ACCENT_LIGHT;
