          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-5 mb-8">
                ...
                <p style={{color: '#4b5563', lineHeight: '1.8', fontSize: '1.05rem'}}>
                  Using Claude and Manus in combination, I map your workflows against what's actually working in your vertical right now. The output is a clean, one-to-three page AI Action Report — no jargon, no fluff. Just where the biggest opportunities are, what to prioritize first, and what it's worth to you.
                </p>
                <p style={{color: '#4b5563', lineHeight: '1.8', fontSize: '1.05rem'}}>
