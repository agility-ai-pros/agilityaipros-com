    ...
    <div class="ba-grid">
      <div class="ba-card before">
        ...
        <ul>
          ...
          <li><span class="icon">×</span><span>List value treated as zero in the studio's revenue plan</span></li>
          <li><span class="icon">×</span><span>No seasonal campaign cadence in place</span></li>
